...
Tässä työssä käytetään neljää kommunikaatiomediateoriaa vastaamaan tutkimuskysymykseen. Nämä teoriat ovat Media Richness, Media Synchronicity, Media Naturalness ja Media Fitness. Teorioiden perusteella muodostetaan hypoteesi ominaisuuksista, jotka ovat arvokkaita palautetyökalulle.
