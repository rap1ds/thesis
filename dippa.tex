...
The purpose of the requirements list was to list all the desired features in detail in a form of a user story. A user story is a one line description which captures the desired functionality from the user point-of-view \citep{userstory}. User stories are written in semi-structured format. In our case, we wrote the user stories in the follwing format: "User can do <action>", for example "User can a text on top of the website".
