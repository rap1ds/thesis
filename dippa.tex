...
Because of the ambiguous use of the latest hyped term and manifold effects of communication, it makes sense to define the term commonly used in this thesis. This section defines the terms commonly used in the thesis.
