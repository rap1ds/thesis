...
Media Synchronicity Theory lists five properties that define medium's capability to support synchronicity. These properties are transmission velocity, parallelism, symbol set, rehearsability and reprocessability.
...
The properties defined in Media Synchronicity Theory are visualized in figure~\ref{fig:mst_properties}.
