...
I was thrilled, even though I didn't understand the code and the flying balloon was not the anything super special. The ability to write some small piece of code that makes the computer to do tasks for you was back then the coolest thing in the world. And it still is.

Since then, I've come a long way as a programmer. The code itself is still interesting, but more and more I've started to become interested in software development by and large. It is fascinating to see how software developers work as a team, how they collaborate and how they communicate. I was very fortuned to being able to write my thesis about a subject that is close to my heart.
...
I want to thank Futurice for supporting the development of the prototype and providing me a calm and peaceful working environment in Master's Thesis room and arranging the Thesis camp.
