...
In this section the protype is evaluated using the communication media theories. The theories were introduced in chapter~\ref{sec:media_theories} and the properties, which are used by the theories to evaluate the effectiveness of the communication media were introduced and discussed. 

The theories also define which properties make the communication tool most suitable to a given communication task. The communication task in hand in this thesis is giving and receiving feedback of a software product. In chapter~\ref{\label{sec:feedback_nature} the nature of feedback communication task was defined.

Using the information from previous chapters about the feedback communication task, the communication tool Hannotaatio and the media theories, the Hannotaatio tool is evaluated with each of the theories. The results of the evaluation are presented in this chapter.
