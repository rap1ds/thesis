...
In this section the prototype feedback tool Hannotaatio is introduced. First, the design and implementation process of the prototype is described. Second, the application architecture and implemented features are presented. Last, the prototype is evaluated using the theories introduced in the previous chapter.

In the previous section the media theories were introduced and explained. The theories were used to explain the nature of feedback communication and what are the properties in communication media that would be beneficial for feedback communication purposes. In this section the same theories are used to evaluate the Hannotaatio prototype. At the end of the section the result of this evaluation is presented. The results show how well does the Hannotaatio prototype support the feedback communication task.
