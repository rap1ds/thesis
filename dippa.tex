...
Alustus: Teen haastattelun diplomityötäni varten. Haastattelulla pyrin selvittämään Hannotaatio palautetyökalun käyttöä sekä palautteen antamista yleisemmin ohjelmistoprojekteissa. Haastattelu nauhoitetaan. 

\begin{enumerate}

1) Titteli, ikä, sukupuoli? Saanko käyttää näitä työssäni?

2) Yritys, jossa työskentelet? Saanko tarvittaessa käyttää näitä työssäni?

3) Kerrotko lyhyesti, mitä sinä ja yrityksesi teette?

4) Miten yrityksessänne hoidetaan palautteen anto asiakas-toimittaja suhteessa?

5) Millaisessa projektissa olette käyttäneet Hannotaatiota?

6) Miten Hannotaation käyttö on muuttanut palautteenantoa, vai onko?

7) Miten paljon arvostat palauttetyökalussa seuraavia ominaisuuksia, miten nämä mielestäsi toteutuvat Hannotaatiossa:
  a) Välitön palaute
  b) Samanaikaisuus
  c) Luonnollisuus
  d) Mahdollisuus viimeistellä
  e) Mahdollisuus uudelleenprosessointiin
  
8) [MNT] Millaisia uusia ominaisuuksia kaipaisit Hannotaatioon [jotta siitä tulisi entistä parempi työkalu palautteenantoon]?
  a) Videokuva palautteen piirtämisestä?
  b) Videokuva + ääniraita
  c) Videokuva + ääniraita + videokuva palautteenantajasta
