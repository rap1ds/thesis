...
There are solutions that allow native-like mobile application development using web technologies. PhoneGap is one of the most proviment frameworks that packages application developed with JavaScript and HTML5 to a container, which looks like a native mobile application. The application can be deployed to all major mobile platforms, such as iOS\footnote{http://www.apple.com/ios/}, Android\footnote{http://www.android.com/} and Windows Phone\footnote{http://www.windowsphone.com/en-us}. Using a container like PhoneGap\footnote{http://phonegap.com/}, Hannotaatio could be used with native mobile applications.
