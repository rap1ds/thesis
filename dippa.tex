...
The interviewees' answers did not fully support Media Naturalness Theory. According to Media Naturalness Theory and Kock's later research, the burden of the e-communication use in on the sender side \citep{kock2007}. Increasing the naturalness of communication media should thus decrease the cognitive effort or sender and make the communication media more appealing to the message sender. However, most of the interviewees answered that they would not like to record their face while giving feedback because it would feel awkward. In addition, recording voice was generally seen as a positive feature, but some negative comments were also included. One interviewee said that recording speech would work well, but not here in Finland because "we are so shy". Another said that recording voice is generally good but may not be convinient for a message sender in a quite office environment. Generally, the ability to record speech was seen as useful feature.
