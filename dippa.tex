...
\begin{figure}[htb]
\begin{center}
\includegraphics[width=1.0\textwidth]{waterfall_reconstructed.png}
\end{center}
\caption{Waterfall process model and feedback. Reconstructed and modified from \citep{royce1970}}
\label{fig:waterfall}
\end{figure}
