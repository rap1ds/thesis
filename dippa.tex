...
There are three main parts in Hannotaatio application architecture: back end server, front end capturer and front end editor. The back end \emph{server} stores the captured websites and annotations and serves them to the front end by request. The \emph{capturer} script is injected to the website which will be captured and it is responsible of capturing the website and sending it to the back end server. The \emph{editor} is responsible of loading the captured website and providing the annotation tools for the user. 
