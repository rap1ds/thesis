...
In this thesis, the organizational context is Futurice Oy, a Finnish IT-company. The company had identified a problem in their communication with the customers and a new IT artifact, feedback tool prototype called Hannotaatio was built. As Nunamaker stated, the process of constructing and exercising innovative IT artifacts enable design-science researchers to understand the problem addressed by the artifact and the feasibility of their approach to its solution.
