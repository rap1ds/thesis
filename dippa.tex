...
Chapter~\ref{sec:methods} discusses the research methods in depth. This thesis uses two main research methods. First, a  prototype of a communication tool designed especially for customer feedback is built. After that, I validate the prototype by interviewing users who have used the prototype in real world software projects.
