...
\subsubsection{How well Hannotaatio supports the properties that are important according to the interviewees?}
...
\textbf{TÄHÄN JOTAIN HANNOTAATIOTA YLISTÄVIÄ QUOTEJA}
...
In conclusion it seems that from six most valued communication media properties, Hannotaatio is able to implement  five of them. The table~\ref{}
...
% Some packages, such as MDW tools, offer better commands for making tables
% than the plain LaTeX2e tabular which is used here.
\begin{tabular}{|p{7.2cm}|p{2.5cm}|}
\hline
\textbf{Communication media property} & \textbf{Hannotaatio's support} \\
\hline
\textbf{Time independent availability} & Good \\
\hline
\textbf{Location independent availability} & Good \\
\hline
\textbf{Immediate feedback} & Poor \\
\hline
\textbf{Natural symbol set} & Good \\
\hline
\textbf{Reprocessability} & Good \\
\hline
\textbf{Sharing} & Good \\
\hline
\end{tabular}
