...
\item How much do you value the following properties in a feedback communication tool?
  \begin{enumerate}
    ...
    \item Possibility to express the feedback in numerous ways or symbols, such as text, image, voice, video, gestures, voice tone? \emph{Number of cues / language variety (MRT, MST, MFT)}
