...
The methods to answer the research question are following. First, previous work in the field of information systems discipline is studied. From the existing literature, a theoretical background about the problem is gethered. Second, based on the previous work, a prototype is designed and built. Last, the prototype is evaluated using qualitative methods, namely semi-structured interviews.

The \emph{design-science} paradigm is used in this thesis. In contrast to behavioral-science, which tries seeks to develop and verify theories, design-science seeks to extend the boundaries of human and organizational capabilities by creating new and innovative artifacts \citep{}.
