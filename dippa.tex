...
\subsubsection{Different communication media for different abstraction level}
...
\subsubsection{How well does Hannotaatio support the properties that are important according to the interviewees?}
...
The visual symbol set used in Hannotaatio is natural and it fits well to the purpose of giving feedback about software product. According to many interviewees, it is much easier to take the screenshot using Hannotaatio than explaining the problem in email. In fact, I argued that in some cases the symbol set used in Hannotaatio is more natural than the symbol set available in face-to-face communication. If the face-to-face communication happens in an environment where neither printed screenshots or a computer with the software under feedback running, the communication parties have to verbally explain different parts of the application. This task can be troublesome. Much easier way to discribe a problem in a software is just point the location from the screenshot.
