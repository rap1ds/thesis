...
Agile software development principles emphasis on intense customer communication. One of the twelve Agile Manifesto principles states that "the most efficient and effective method of conveying information to and within a development team is face-to-face conversation". \citep{agilemanifesto} As a result, eXtreme Programming (XP), which is one of the agile software process frameworks demanded an onsite-customer to support face-to-face communication 
