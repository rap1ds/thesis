...
\item How much do you value the following properties in a feedback communication tool?
  \begin{enumerate}
    ...
    \item Ability to be in multiple comminucation sessions simultaneously (for example, face-to-face communication allows only one simultaneous session where as \ac{IM} allows multiple chat rooms open at the same time) \textit{Parallelism (MST)
