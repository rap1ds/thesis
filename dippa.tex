...
Hannotaatio is implemented using mainly JavaScript and Ruby On Rails. For old browser compatibility, some parts of the capturer utilizes Adobe Flash for capturing images with browsers that do not support HTML5 Canvas elements.
