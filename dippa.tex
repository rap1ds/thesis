...
Chapter 3 introduces the introduces the Hannotaatio feedback tool prototype. The design and implementation of the prototype are discussed in detail. In this chapter, the prototype tool is teorethically evaluated according to the media theories studied in chapter~\ref{sec:literature}.
