...
There are also number of relevant communication theories that were excluded from this thesis. For example, \emph{Social Influence theories} and social aspects to the effectiveness of communication were are excluded. The main argument of social influence (SI) model is that media choice and use are not only objective and rational as stated in work previous to formulation of social influence model \citep{}. Instead, media properties such as richness are posited to be subjective, influenced by to some degree by attitudes, statements and behaviours of other in the workplace. Although \citet{schmitz1991} admit that the relative objective features of communication media do affect how individuals perceive the media and its effeciency its only part of the equation.
