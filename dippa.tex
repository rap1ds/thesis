...
\ac{MFT} provides a framework to calculate the task-media fitness. The fitness is calculated by first defining the properties of the communication media according to the 13 properties of the theory. After that, the needs of the communication task in question are defined. The fitness can be calculated, when both communication media and communication task are defined.
