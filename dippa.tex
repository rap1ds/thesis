...
"We are daily in touch with the people who are going to use the end product [we are implementing], i.e. we are in tight interconnection with the customer. We can just go and ask the customer this [implemented feature] worked. [...] [Most of the communication] happens through one-to-one communication, whether is happens via email or telephone. 
