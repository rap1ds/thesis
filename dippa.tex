...
\item Titteli, ikä, sukupuoli? Saanko käyttää näitä työssäni?
...
\item Miten paljon arvostat palauttetyökalussa seuraavia ominaisuuksia, miten nämä mielestäsi toteutuvat Hannotaatiossa:
  \begin{enumerate}
    \item Välitön palaute
    \item Samanaikaisuus
    \item Luonnollisuus
...
\item Millaisia uusia ominaisuuksia kaipaisit Hannotaatioon (jotta siitä tulisi entistä parempi työkalu palautteenantoon)?
  \begin{enumerate}
