...
\DeclareAcronum{MFT}{
    short = MFT,
    long = media fitness theory,
    alt = Media Fitness Theory
}
...
\begin{itemize}
  \item immediate feedback (MRT, MST, \ac{MFT})
  \item personality (MRT)
  \item rich symbol set (MRT, MST, \ac{MFT})
  \item natural symbol set (MRT, MST, \ac{MFT})
  \item parallelism (MST)
  \item rehearsability (MST)
  \item reprocessability (MST)
  \item security (\ac{MFT})
  \item sharing (\ac{MFT})
  \item retrieval (\ac{MFT})
  \item multiparty (\ac{MFT})
  \item available time (\ac{MFT})
  \item available location (\ac{MFT})
  \item price (\ac{MFT}). 
\end{itemize}
