...
To address this issue, Agile development relies on intense communication and frequent feedback between customer and supplier. Instead of fixed scope, fixed time contracts, agile development relies on negotiated scope contracts as a mechanism for aligning the interests of supplier and customer to encourage communication and feedback \citep{beck2004}.
