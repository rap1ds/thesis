...
The editor is responsible of loading the saved DOM tree and \ac{CSS} styles from backend server. The source is then rendered in a iframe container. On top of the iframe container, a drawing canvas is created. The canvas allows user to draw the feedback and save it for sharing.
