...
Rehearsability stands for the message sender's ability to practice and fine tune the message before sending it. For example, email and other asynchronous e-commnunication media support rehearsability well. Email sender can carefully consider the wordings in the message and she can change the wordings before sending the message. High rehearsability reduces the possiblity for message receiver misunderstand the message. However, rehearsability adds delays to the conversation.
