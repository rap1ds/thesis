...
On the other hand, some projects did not have a dedicated person to collect the feedback, analyze it and act accordingly. However, it has been noted that this particular issue was in an internal development project, where there were no official organizational boundaries crossing supplier--customer relationship. Propably due to the fact that the supplier--customer relationship was in fact missing, the internal project and its feedback process was not taken as seriously as it is in supplier--customer projects.
