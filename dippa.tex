...
Communication is extremely human-oriented business. However, in this thesis the social perspective of communication is not in the main focus. Instead, this thesis consentraits on the non-social properties of the communication media. For example, instead of asking, what are the properties in a communication tool that makes the customer and developer to bond or what are the properties that make the customer to feel that he has been served with a high level of customer service, I ask, what are the properties in a communication tool makes feedback transfomation from the customer to developmer efficient in order for developer to act accordingly.
