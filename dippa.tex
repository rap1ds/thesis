...
Tässä työssä käytetään neljää kommunikaatiomediateoriaa vastaamaan tutkimuskysymykseen. Nämä teoriat ovat Media Richness, Media Synchronicity, Media Naturalness ja Media Fitness. Teorioista muodostetaan hypoteesi ominaisuuksista, jotka ovat arvokkaita palautetyökalulle.
...
Hypoteesi validoidaan haastattelemalla Hannotaatio prototyypin käyttäjiä. Hannotaatio on työkalu visuaalisen palautteen antamiseen web-sivustosta ottamalla kuvakaappaus sivusta ja piirtämällä sen päälle. Myös prototyypin toimivuutta validoidaan haastatteluilla.
