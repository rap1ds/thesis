...
There are solutions that allow native-like mobile application development using web technologies. PhoneGap is one of the most proviment frameworks that packages application developed with JavaScript and HTML5 to a container, which looks like a native mobile application. Using a container like PhoneGap, Hannotaatio could be used with native mobile applications. 
