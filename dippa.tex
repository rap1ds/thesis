...
In this section the protype is evaluated using the communication media theories. The theories and the properties, which are used by the theories to evaluate the effectiveness of the communication media were introduced and discussed  in chapter~\ref{sec:media_theories}. 
