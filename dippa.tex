...
The installation of Hannotaatio requires minimal amount of coding and configuration. In the simplest case user does not have to do anything else that copy the code snippet provided in Hannotaatio website to user's own site.
