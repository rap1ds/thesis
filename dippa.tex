...
\textbf{In} \emph{this} \underline{thesis} \textit{customer} refers to a person in a software project who is the feedback provider. In the context of external software projects customer refers to a representative from the customer organization who gives feedback to the supplier organization. In the context of internal software project customer refers to the representative in the internal organization who is in response of the project outcode and who provides the feedback to the development team.
...
I-2 Security & 3 (avoid to be known by anyone except certain people) \\
\hline
I-3 Sharing & 5 (intentionally designed to be sharable) \\
\hline
I-4 Retrieval & 2 (semi-automatic indexing) \\
\hline
I-5 Multiparty & 2 (about three to six people) \\
\hline
I-6 Expressive power & (1) Text: ABcCd (printed, digitalized, not formatted or formatted only for easy reading, strictly formatted/structured according to certain standard, plain text), (2) Picture: ABcC (digitalized, colored, low quality/resolution, high quality/resolution), (3) Voice: *, (4) Video: * \\
\hline
\end{tabular}
\end{table}

JATKAHAN TÄSTÄ ETEENPÄIN!
