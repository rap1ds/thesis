...
In addition to conflicting situations, there were a lot of reasons why storing the feedback for later use was seen important.
...
\q{3}{It is important that there is a record of the feedback given and you can go back to it.
...
Interviewee: Yeah, it maybe did. Usually the feedback culminates to a desicion, for example in a [work task] prioritization. It may be so that one remembers better the feedback that is similar to your own opinions where as some other feedback you forget easily. Thus, it might be good that one could go back to the feedback.
