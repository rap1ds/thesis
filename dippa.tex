...
Good usability was one of the main design requirement for Hannotaatio. This has been addressed by for example selecting technologies that do not require user to install any browser plugin. In other words, the customer does not have to install anything to be able to use Hannotaatio. This lowers the barrier to start using Hannotaatio first time.
