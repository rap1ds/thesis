...
Chapter~\ref{sec:methods} discusses the research methods in depth. In addition to the literature review and teorethical evaluation of the prototype tool, this thesis uses qualitative methods to answer to the research question. Semi-structured interviews are conducted for nine people who have used the prototype in a real-world software projects.

The results are presented in chapter~\ref{sec:results}. The interview results and quotes from the interviewees are presented in this chapter.

Chapter ~\ref{sec:discussion} concludes the results of the study, discusses about the limitations of the research and proposes further research subjects.
